...
const Footer: FunctionComponent = () => {
  return (
    <footer className="py-12 bg-gradient-to-t from-primary-900 via-primary-800 to-primary-900 text-neutral-200 relative overflow-hidden">
      {/* Overlay leve */}
      <div className="absolute inset-0 bg-black/20 pointer-events-none"></div>

      <div className="container mx-auto text-center px-6 relative z-10">
        <p className="mb-3 text-lg md:text-xl animate-fadeInUp">
          &copy; {new Date().getFullYear()} Congresso Jovens 2026 - IEADPE
          Petrolina
        </p>
        <p className="text-sm md:text-base text-neutral-300 animate-fadeInUp delay-100">
